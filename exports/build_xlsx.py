...
brand_existing(os.path.join(ROOT,'investors','partners','PARTNER_WAR_ROOM.xlsx'),os.path.join(OUT,'Partner_War_Room.xlsx'),'Partner War Room','88 target organisations and contacts with the job title to approach, a CRM with the eleven-stage partner pipeline, stage rules and monthly KPIs.')
