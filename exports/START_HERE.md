...
| `finance/` | 3-year financial model workbook (three scenarios) and its builder script |
| `investors/` | Investor CRM (xlsx and csv), Top 25, call lists, outreach engine, pipeline dictionary, non-dilutive routes |
| `product/` | MaternaLink PRD, MVP spec, roadmap, feature addendum |
| `website/` | Vytalix corporate website (14 pages, static) |
| `maternalink-site/` | MaternaLink product website with demo dashboard (8 pages, static) |
| `operations/` | KPI dashboard and pipeline tracker templates |
| `brand/` | Vytalix logo files |

## Before anything goes to an investor or a government
Entity incorporated · IP deed signed · 2025 clinical claims retired · prototype behind authentication with synthetic data · one-pager and deck updated with real dates and names · data room assembled (index in doc 23 §2).
